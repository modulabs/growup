...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--><th class="px-1 py-1 text-center min-w-[60px] border-b border-gray-300"><button class="w-8 h-8 rounded-md border border-dashed border-gray-300 text-gray-500 hover:text-blue-600 hover:border-blue-400 cursor-pointer">+</button></th></tr></thead><tbody>`);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<tr><td${attr("colspan", sortedQuests.length + 2)} class="px-3 py-6 text-center text-gray-500">점수표를 불러오는 중입니다...</td></tr>`);
    }
